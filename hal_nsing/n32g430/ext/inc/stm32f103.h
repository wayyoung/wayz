...
#define DMA_IFCR_CTCIF7_Msk                 (0x1UL << DMA_IFCR_CTCIF8_Pos)
#define DMA_IFCR_CTCIF7                     DMA_IFCR_CTCIF8_Msk           
#define DMA_IFCR_CHTIF7_Pos                 (26U)
#define DMA_IFCR_CHTIF7_Msk                 (0x1UL << DMA_IFCR_CHTIF8_Pos)
#define DMA_IFCR_CHTIF7                     DMA_IFCR_CHTIF8_Msk           
#define DMA_IFCR_CTEIF7_Pos                 (27U)
#define DMA_IFCR_CTEIF7_Msk                 (0x1UL << DMA_IFCR_CTEIF8_Pos)
#define DMA_IFCR_CTEIF7                     DMA_IFCR_CTEIF8_Msk           
