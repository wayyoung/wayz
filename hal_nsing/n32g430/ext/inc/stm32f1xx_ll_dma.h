...
{
  (uint8_t)(DMA1_CH1_BASE - DMA1_BASE),
  (uint8_t)(DMA1_CH2_BASE - DMA1_BASE),
  (uint8_t)(DMA1_CH3_BASE - DMA1_BASE),
  (uint8_t)(DMA1_CH4_BASE - DMA1_BASE),
  (uint8_t)(DMA1_CH5_BASE - DMA1_BASE),
  (uint8_t)(DMA1_CH6_BASE - DMA1_BASE),
  (uint8_t)(DMA1_CH7_BASE - DMA1_BASE),
  (uint8_t)(DMA1_CH8_BASE - DMA1_BASE),
};
/**
  * @}
  */
...
{
  return (READ_BIT(DMAx->ISR, DMA_ISR_GIF8) == (DMA_ISR_GIF8));
}
...
{
  return (READ_BIT(DMAx->ISR, DMA_ISR_TCIF8) == (DMA_ISR_TCIF8));
}
...
{
  return (READ_BIT(DMAx->ISR, DMA_ISR_HTIF8) == (DMA_ISR_HTIF8));
}
...
{
  return (READ_BIT(DMAx->ISR, DMA_ISR_TEIF7) == (DMA_ISR_TEIF8));
}
