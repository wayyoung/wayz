...
#define DMA_REMAP_TIM2_CH3 ((uint32_t)0x0000001A)  /* DMA Request For TIM2_CH3 */
#define DMA_REMAP_TIM2_CH4 ((uint32_t)0x0000001B)  /* DMA Request For TIM2_CH4 */
#define DMA_REMAP_TIM2_UP ((uint32_t)0x0000001C)   /* DMA Request For TIM2_UP */
