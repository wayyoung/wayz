...
#define I2C_EVT_MASTER_MODE_FLAG (((uint32_t)I2C_STS1_STARTBF) | ((((uint32_t)I2C_STS2_BUSY) | ((uint32_t)I2C_STS2_MSMODE)) << 16))
...
#define I2C_EVT_MASTER_TXMODE_FLAG (((uint32_t)I2C_STS1_ADDRF) | ((uint32_t)I2C_STS1_TXDATE) | ((((uint32_t)I2C_STS2_BUSY) | ((uint32_t)I2C_STS2_MSMODE) | ((uint32_t)I2C_STS2_TRF)) << 16))
/* BUSY, MSMODE and ADDRF flags */
#define I2C_EVT_MASTER_RXMODE_FLAG (((uint32_t)I2C_STS1_ADDRF) | ((((uint32_t)I2C_STS2_BUSY) | ((uint32_t)I2C_STS2_MSMODE)) << 16))
/* --EV9 */
/* BUSY, MSMODE and ADD10RF flags */
#define I2C_EVT_MASTER_MODE_ADDRESS10_FLAG (((uint32_t)I2C_STS1_ADDR10F) | ((((uint32_t)I2C_STS2_BUSY) | ((uint32_t)I2C_STS2_MSMODE)) << 16))
...
#define I2C_EVT_MASTER_DATA_RECVD_FLAG (((uint32_t)I2C_STS1_RXDATNE) | ((((uint32_t)I2C_STS2_BUSY) | ((uint32_t)I2C_STS2_MSMODE)) << 16))

/* EV7x shifter register full */
/* BUSY, MSMODE, BSF and RXDATNE flags */
#define I2C_EVT_MASTER_DATA_RECVD_BSF_FLAG (((uint32_t)I2C_STS1_RXDATNE) | ((uint32_t)I2C_STS1_BSF) | ((((uint32_t)I2C_STS2_BUSY) | ((uint32_t)I2C_STS2_MSMODE)) << 16))

/* Master TRANSMITTER mode --------------------------*/
/* --EV8 */
/* TRF, BUSY, MSMODE, TXDATE flags */
#define I2C_EVT_MASTER_DATA_SENDING (((uint32_t)I2C_STS1_TXDATE) | ((((uint32_t)I2C_STS2_BUSY) | ((uint32_t)I2C_STS2_MSMODE) | ((uint32_t)I2C_STS2_TRF)) << 16))
/* --EV8_2 */
/* TRF, BUSY, MSMODE, TXDATE and BSF flags */
#define I2C_EVT_MASTER_DATA_SENDED (((uint32_t)I2C_STS1_BSF) | ((uint32_t)I2C_STS1_TXDATE) | ((((uint32_t)I2C_STS2_BUSY) | ((uint32_t)I2C_STS2_MSMODE) | ((uint32_t)I2C_STS2_TRF)) << 16))
...
#define I2C_EVT_SLAVE_RECV_ADDR_MATCHED (((uint32_t)I2C_STS1_ADDRF) | ((((uint32_t)I2C_STS2_BUSY)) << 16))
    /* TRF, BUSY, TXDATE and ADDRF flags */
#define I2C_EVT_SLAVE_SEND_ADDR_MATCHED (((uint32_t)I2C_STS1_TXDATE) | ((uint32_t)I2C_STS1_ADDRF) | ((((uint32_t)I2C_STS2_BUSY) | ((uint32_t)I2C_STS2_TRF)) << 16))
...
#define I2C_EVT_SLAVE_SEND_ADDR2_MATCHED (((uint32_t)I2C_STS1_TXDATE) | ((((uint32_t)I2C_STS2_BUSY) | ((uint32_t)I2C_STS2_DUALFLAG) | ((uint32_t)I2C_STS2_TRF)) << 16))
...
#define I2C_EVT_SLAVE_DATA_RECVD (((uint32_t)I2C_STS1_RXDATNE) | ((((uint32_t)I2C_STS2_BUSY)) << 16))
    /* --EV2x */
...
#define I2C_EVT_SLAVE_DATA_SENDED (((uint32_t)I2C_STS1_BSF) | ((uint32_t)I2C_STS1_TXDATE) | ((((uint32_t)I2C_STS2_BUSY) | ((uint32_t)I2C_STS2_TRF)) << 16))
    /* TRF, BUSY and TXDATE flags */
#define I2C_EVT_SLAVE_DATA_SENDING (((uint32_t)I2C_STS1_TXDATE) | ((((uint32_t)I2C_STS2_BUSY) | ((uint32_t)I2C_STS2_TRF)) << 16))
    /* --EV3_2 */
    /* AF flag */
