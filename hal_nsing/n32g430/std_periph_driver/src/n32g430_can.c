...
{
    CANx->BTIM = (uint32_t)((uint32_t)CAN_initializes_parameter->OperatingMode << CAN_OPERATING_MODE_OFFSET) | ((uint32_t)CAN_initializes_parameter->RSJW << CAN_RSJW_OFFSET) | ((uint32_t)CAN_initializes_parameter->TBS1 << CAN_TBS1_OFFSET) | ((uint32_t)CAN_initializes_parameter->TBS2 << CAN_TBS2_OFFSET) | ((uint32_t)CAN_initializes_parameter->BaudRatePrescaler - 1);
}
                                ...
                                uint32_t filter_position)
{
    ...
    if (CAN_filter_initializes_structure->Filter_Scale == CAN_FILTER_16BITSCALE)
    {
        ...
        CAN->sFilterRegister[CAN_filter_initializes_structure->Filter_Num].FR1 =
            ((0x0000FFFF & (uint32_t)CAN_filter_initializes_structure->FilterMask_LowId) << CAN_FRX_ID_OFFSET) | (0x0000FFFF & (uint32_t)CAN_filter_initializes_structure->Filter_LowId);

        /* Second 16-bit identifier and Second 16-bit mask */
        /* Or Third 16-bit identifier and Fourth 16-bit identifier */
        CAN->sFilterRegister[CAN_filter_initializes_structure->Filter_Num].FR2 =
            ((0x0000FFFF & (uint32_t)CAN_filter_initializes_structure->FilterMask_HighId) << CAN_FRX_ID_OFFSET) | (0x0000FFFF & (uint32_t)CAN_filter_initializes_structure->Filter_HighId);
    }
    else
    {
        /*No process*/
                                ...
                                uint32_t filter_position)
{
    ...
    if (CAN_filter_initializes_structure->Filter_Scale == CAN_FILTER_32BITSCALE)
    {
        ...
        CAN->sFilterRegister[CAN_filter_initializes_structure->Filter_Num].FR1 =
            ((0x0000FFFF & (uint32_t)CAN_filter_initializes_structure->Filter_HighId) << CAN_FRX_ID_OFFSET) | (0x0000FFFF & (uint32_t)CAN_filter_initializes_structure->Filter_LowId);
        /* 32-bit mask or Second 32-bit identifier */
        CAN->sFilterRegister[CAN_filter_initializes_structure->Filter_Num].FR2 =
            ((0x0000FFFF & (uint32_t)CAN_filter_initializes_structure->FilterMask_HighId) << CAN_FRX_ID_OFFSET) | (0x0000FFFF & (uint32_t)CAN_filter_initializes_structure->FilterMask_LowId);
    }
    else
    {
        /*No process*/
...
void CAN_Transmit_Message_Data_Config(CAN_Module *CANx, CanTxMessage *transmit_message,
                                      uint8_t mailbox_queue)
{
    CANx->sTxMailBox[mailbox_queue].TMDL = (((uint32_t)transmit_message->Data[3] << CAN_RMDL_DATA3_OFFSET) | ((uint32_t)transmit_message->Data[2] << CAN_RMDL_DATA2_OFFSET) | ((uint32_t)transmit_message->Data[1] << CAN_RMDL_DATA1_OFFSET) | ((uint32_t)transmit_message->Data[0]));
    CANx->sTxMailBox[mailbox_queue].TMDH = (((uint32_t)transmit_message->Data[7] << CAN_RMDH_DATA7_OFFSET) | ((uint32_t)transmit_message->Data[6] << CAN_RMDH_DATA6_OFFSET) | ((uint32_t)transmit_message->Data[5] << CAN_RMDH_DATA5_OFFSET) | ((uint32_t)transmit_message->Data[4]));
}
